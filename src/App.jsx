...
function ClockTimer({ timeLeft }) {
  ...
  return (
    <div style={styles.clockWrap}>
      <svg width="34" height="34" viewBox="0 0 54 54" style={{ transform: "rotate(-90deg)" }}>
    ...
    <div style={styles.playWrap}>
      ...
      <div style={styles.hudRow}>
        <div style={styles.panel}>
          <div style={styles.panelLabel}>TIME</div>
          <ClockTimer timeLeft={game.timeLeft} />
        </div>
        <div style={styles.panel}>
          <div style={styles.panelLabel}>RAs</div>
          <RaRosterMini game={game} />
        </div>
        <div style={styles.panel}>
          <div style={styles.panelLabel}>STRIKES</div>
          <StrikesMini strikes={game.strikes} />
        </div>
        <div style={styles.panel}>
          <div style={styles.panelLabel}>PARTY</div>
...
const styles = {
  ...
  panelLabel: { fontFamily: "'Press Start 2P', monospace", fontSize: "0.32em", color: "#8fa3d1" },
  clockWrap: { position: "relative", width: 34, height: 34 },
  ...
  raMiniCol: { display: "flex", flexDirection: "row", gap: 4 },
  raMiniRow: { display: "flex", justifyContent: "center" },
  raMiniIcon: { width: 18, height: 18, borderRadius: 4, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.55em" },
  pips: { display: "flex", flexDirection: "row", gap: 3, alignItems: "center" },
